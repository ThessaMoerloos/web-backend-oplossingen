...
function optellen ( $getal1, $getal2 )
  ...
  function vermenigvuldig ( $getal1, $getal2 )
    ...
    function isEven ( $getal1)
    	{
    		$quotient = $getal1%2;    //bv: 5%2 = 2.5

        if ($quotient == 0) {  //bv 2.5 > 0
          return "true";
        }
        else {
          return "false";
      ...
      function stringOef ( $woord)    // bv panda
        {
          $woordlengte = strlen($woord);
          $toUpper = strtoupper($woord);
          return array($woordlengte, $toUpper );
            ...
            <ul>
                ...
                <li>Maak een functie <code>vermenigvuldig</code> die 2 parameters heeft, <code>$getal1</code> en <code>$getal2</code>
                    ...
                    <ul>
                        ...
                        <li>Deze functie returnt het resultaat</li>
                      <p><?php echo vermenigvuldig(5,6) ?> </p>
                    </ul>
                </li>
                ...
                <p> <?php print_r (stringOef("panda")) ?> </p>
            </ul>
