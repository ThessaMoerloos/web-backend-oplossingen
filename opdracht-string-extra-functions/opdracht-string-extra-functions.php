<?php 
    ...
    $letterO 		 = "o";
    $eersteO         = strpos($fruit, $letterO); 

    $fruit2          = "ananas";
    $letterA 		 = "a";
    $negatief        = "-1";
    $laatsteA        = strrpos ($fruit2, $letterA);
    $strToUpperCase  = strtoupper($fruit2);


    $lettertje      = "e";
    $cijfertje      =   3;
    $langsteWoord   = "zandzeepsodemineralenwatersteenstralen";
    $replaceEto3    = str_replace($lettertje, $cijfertje, $langsteWoord);
