<?php 
    $jaartal        = 2000;
    $Schrikkeljaar  = "Is het een schrikkeljaar?";

  



    if($jaartal % 4 == 0 )  // is true/false
    {
        $Schrikkeljaar =  "Het is een schrikkeljaar!";
    }
    else{
        $Schrikkeljaar =  "Het is geen schrikkeljaar!";
    }
    ...
    $aantalMin      = floor( $aantalSeconden/60);
    $uur            = 60 * $aantalMin;
    $aantalUur      = floor( $aantalMin/60); 
    $dag            = 24 * $aantalUur;
    $aantalDagen    = floor( $aantalSeconden/ $dag); 
    /*$aantalWeken    = floor( );*/
    /*$aantalJaren    = $aantalSeconden/$jaar;
    $aantalMaanden  = $aantalSeconden/12;*/
            ...
            <ul>
                <li>Maak een PHP-script dat kan bepalen of de variabele 'jaartal' al dan niet een schrikkeljaar is
                    <ul>
                        ...
                        <p> Het is het jaar: <?php echo $jaartal ?>. <?php echo $Schrikkeljaar ?> </p>
                    </ul>
                </li>
            </ul>  
                ...
                <li>
                    ...
                    <div class="facade-minimal" data-url="http://www.app.local/index.php">
                        ...
                        <ul>
                            ...
                            <li>uren:     <?php echo  $aantalUur ?></li> 
                            <li>dagen:    <?php echo  $aantalDagen ?></li>
                            <li>weken:    <?php echo  $jaartal ?></li>
                            <li>maanden:  <?php echo  $jaartal ?></li>  
                            <li>jaren:    <?php echo  $jaartal ?> </li>
                        </ul>
                    </div>
