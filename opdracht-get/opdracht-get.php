...
$artikels = array(	   array("titel" 	=> 	"Lot van Marslander Schiaparelli onduidelijk",
                              "datum" 	=> 	"19/10/16 - 16u58",
                              "afbeelding" => "art1.jpg",
                              "afbeeldingBeschrijving" => "Marslander Schiaparelli",
                              "inhoud" 	=> 	"Een Europese satelliet is vandaag in een baan rond Mars gekomen. Maar het is niet duidelijk of het is gelukt om een laboratorium op Mars te laten landen. Die lander heeft geen signaal rechtstreeks naar de aarde gestuurd. De vluchtleiding in Duitse stad Darmstadt wachtte er gespannen op, maar tevergeefs.
...
Europa voert de missie uit met Rusland. Het totale project - lander, satelliet en verkenner - kost Europa ruim 1 miljard euro. ",
                        ...
                        array( "titel" 	=> 	"Kosmische straling zal astronauten naar Mars dement en paranoïde maken",
                                "datum" 	=> 	"11/10/16 - 18u07",
                                "afbeelding" => "art2.jpg",
                                "afbeeldingBeschrijving" => "astronaut",
                                "inhoud" 	=> 	" Amerikaans president Obama wil mensen op Mars laten wonen, zo maakte hij vandaag bekend. 'Die reuzensprong zal Amerika maken', liet hij weten. Vrijwilligers genoeg, alleen moeten die weten dat ze door de kosmische straling risico lopen dement en/of paranoïde te worden. Daarvoor waarschuwt een nieuwe studie.
