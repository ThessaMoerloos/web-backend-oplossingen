...
function Functie1($argument1)
{
  global $md5HashKey;
  global $lengte;

  //static $aantalKeer = 0;
  $aantalKeer = substr_count( $md5HashKey, $argument1);

  $procent    = (($aantalKeer / $lengte)*100);
...
function Functie2($argument2)
{
  $md5HashKey   = "d1fa402db91a7a93c4f414b8278ce073";
  $lengte       = strlen($md5HashKey);

  $aantalKeer = substr_count( $md5HashKey, $argument2);
  $procent    = (($aantalKeer / $lengte)*100);

  return $procent;
}

function Functie3($argument3, $md5HashKey)
{
  global $lengte;

  $aantalKeer = substr_count( $md5HashKey, $argument3);
  $procent    = (($aantalKeer / $lengte)*100);
...
//callback
$functie3 = Functie3("a", $md5HashKey );
                ...
                <li>Spreek elke functie één keer aan, telkens met een ander argument:
                    <ul>
                        <li>Argument Functie 1: <code>'2'</code></li>
                          <p> De needle '2' komt <?php echo Functie1("2") ?>% voor in de hash key 'd1fa402db91a7a93c4f414b8278ce073 </p>
                        <li>Argument Functie 2: <code>'8'</code></li>
                          <p> De needle '8' komt <?php echo Functie2("8") ?>% voor in de hash key 'd1fa402db91a7a93c4f414b8278ce073 </p>
                        <li>Argument Functie 3: <code>'a'</code></li>
                          <p> De needle 'a' komt <?php echo Functie3("a", $md5HashKey)  ?>% voor in de hash key 'd1fa402db91a7a93c4f414b8278ce073 </p>
                          <p> Met Callback: De needle 'a' komt <?php echo $functie3  ?>% voor in de hash key 'd1fa402db91a7a93c4f414b8278ce073 </p>
                    </ul>
                </li>
